...
This repository demonstrates how to visualize river classifications across Iran using the Global River Classification (GloRiC) dataset with using R programming language.
